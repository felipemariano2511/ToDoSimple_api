package br.com.felipemariano.toDoSimple.controllers;

import br.com.felipemariano.toDoSimple.models.Task;
import br.com.felipemariano.toDoSimple.services.TaskService;
import br.com.felipemariano.toDoSimple.services.UserService;
...
public class TaskController {
    ...
    @GetMapping("/user/{userId}")
      public ResponseEntity<List<Task>> findAllUserId(@PathVariable Long userId) {
        ...
        List<Task> objs = this.taskService.findAllUserId(userId);
